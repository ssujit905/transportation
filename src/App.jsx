...
export default function App() {
  ...
  return (
    <>
          ...
          <div className="container nav-wrap">
            ...
            <nav id="site-nav" className={`site-nav${menuOpen ? " open" : ""}`}>
              ...
              <div className="nav-links">
                ...
                <a href="#contact-us" className="nav-cta" onClick={handleNavClick}>
                  Get Quote
                </a>
              </div>
            </nav>
      ...
      <main>
        <section className="hero-banner" aria-label="Transport showcase images">
        ...
        <section className="section why-us" id="contact-us">
          <div className="container">
            <div className="section-heading section-heading-centered">
              <h2>Contact Us</h2>
              <p className="section-subtitle">
